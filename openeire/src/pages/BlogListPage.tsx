...
const BlogListPage: React.FC = () => {
  ...
  return (
    <div className="bg-black min-h-screen text-white pt-24 pb-20 mobile-page-offset">
      <SEOHead
        title={currentTag ? `Journal: ${currentTag}` : "Journal"}
        description="Read behind-the-scenes notes, drone capture stories, and photography insights from OpenÉire Studios."
        canonicalPath="/blog"
