  ...
  return (
    <div className="bg-black min-h-screen text-white">
      <SEOHead
        ...
        description="Read the terms and conditions governing purchases, licensing, and use of the OpenÉire Studios website and products."
        canonicalPath="/terms"
      />
      ...
      <p>
        ...
        <Link to="/licensing/terms">Licensing Terms & Legal Agreement</Link>{" "}
        page.
